...
class FBMeViewController: FBMeBaseViewController {
    ...
    private let tableView: UITableView = {
        ...
        view.register(FBMeBaseCell.self, forCellReuseIdentifier: FBMeBaseCell.cellId)
        return view
    }()
...
extension FBMeViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if title == user.name {
            ...
            cell = tableView.dequeueReusableCell(withIdentifier: FBMeBaseCell.cellId, for: indexPath)
        }
