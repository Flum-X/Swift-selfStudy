...
//  SwiftProject13
//
//  Created by DaXiong on 2018/10/16.
...
class ViewController: UIViewController {
    ...
    func animateTable() {
        ...
        var index = 0
        for cell in cells {
            UIView.animate(withDuration: duration, delay: 0.05 * Double(index), usingSpringWithDamping: 0.8, initialSpringVelocity: 0, options: [], animations: { cell.transform = CGAffineTransform(translationX: 0, y: 0)
            }, completion: nil)
            index += 1
        }
    }
